...
class SmartCoachFeedback:
    ...
    specific_suggestions: list[Dict[str, str]]  # {"type": "improvement", "text": "...", "priority": "high"}
...
class ReconversionPlan:
    ...
    recommended_resources: list[Dict[str, str]]  # {"type": "course|book|certification", "name": "...", "url": "..."}
