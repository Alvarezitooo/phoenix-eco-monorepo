...
from utils.security import DataAnonymizer, InputValidator
...
class DBService:
    ...
    def add_mood_entry(
        self, user_id: str, mood: int, energy: int, confidence: int, notes: str
    ) -> Dict:
        """
        ...
        try:
            ...
            if mood is None or energy is None or confidence is None:
                return {
                    "success": False,
                    "error": "Scores invalides (doivent être entre 1 et 10)",
                }
    ...
    def get_user_stats(self, user_id: str) -> Dict:
        ...
        return {
            ...
            "trend": (
                "📈" if len(entries) > 1 and mood_scores[0] > mood_scores[-1] else "➡️"
            ),
        }
