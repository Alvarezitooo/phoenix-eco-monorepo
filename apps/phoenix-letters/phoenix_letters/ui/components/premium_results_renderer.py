...
class PremiumResultsRenderer:
    ...
    def render_score_gauge(
        self, score: float, title: str, max_score: float = 100
    ) -> None:
    ...
    def render_keyword_cloud(
        self, keywords: List[str], title: str = "Mots-clés identifiés"
    ) -> None:
    ...
    def render_recommendations_list(
        self, recommendations: List[str], title: str = "Recommandations"
    ) -> None:
    ...
    def render_confidence_indicator(
        self, confidence: float, title: str = "Niveau de confiance"
    ) -> None:
    ...
    def render_comparison_table(
        self, data: Dict[str, Any], title: str = "Analyse comparative"
    ) -> None:
