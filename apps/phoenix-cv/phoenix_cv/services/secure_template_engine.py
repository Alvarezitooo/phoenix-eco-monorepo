...
class SecureTemplateEngine:
    ...
    def render_cv_secure(
        self, profile: CVProfile, template_id: str, for_export: bool = False
    ) -> str:
    ...
    def _render_template_secure(
        self, template: CVTemplate, profile: CVProfile, for_export: bool
    ) -> str:
